...
| W3-extra — comprehensive MPLS | label codec (3032), BGP-LU dataplane mirror, LDP (5036) + dual-stack (7552) + transit allocation + loop detection + GR (3478), kernel mirror, SR-MPLS slices 1–3 (RFC 8665/8660/8661) | SR-MPLS complete; SRv6 slice 1 (data plane) landed — see [`ROADMAP.md` §W3-extra](ROADMAP.md#w3-extra--comprehensive-mpls-support-new) |
