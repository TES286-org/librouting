...
2. **OSPFv3 daemon depth** — slice 1 landed: the daemon runs v3 end
   ...
   (RFC 5187). SRv6 is no longer part of this gap — the RFC 9513
   control plane and its daemon origination/reception surface landed
   (see the OSPFv3 SRv6 row above). The v3 codec + LSA + SPF surfaces
   are in the capability tables above.