...
./tests/interop/ospf_sr_frr.sh              # needs FRR (or skips) — RFC 8667 slice 1; SRDB + phase-2 reception kernel-MPLS-gated
./tests/interop/ospf_sr.sh                  # RFC 8667 slice 2 — SR reception, lr x lr (no kernel MPLS needed)
